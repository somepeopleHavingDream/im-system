...
import org.yangxin.im.common.config.GlobalHttpClientConfig;

import java.io.IOException;
import java.util.Map;

@SuppressWarnings({"SpringJavaAutowiredFieldsWarningInspection", "DuplicatedCode", "CallToPrintStackTrace"})
@Component
