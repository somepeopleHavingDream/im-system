package org.yangxin.im.service.friendship.dao.mapper;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import org.apache.ibatis.annotations.Mapper;
import org.apache.ibatis.annotations.Select;
import org.yangxin.im.service.friendship.dao.ImFriendShipEntity;
import org.yangxin.im.service.friendship.model.req.CheckFriendShipReq;
...
public interface ImFriendShipMapper extends BaseMapper<ImFriendShipEntity> {
    ...
    @Select(
            " select to_id from im_friendship where from_id = #{userId} AND app_id = #{appId} and status = 1 and " +
                    "black = 1 "
    )
