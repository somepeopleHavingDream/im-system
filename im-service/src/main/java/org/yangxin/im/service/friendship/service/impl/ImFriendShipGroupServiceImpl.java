...
import org.yangxin.im.service.friendship.dao.mapper.ImFriendShipGroupMapper;
...
public class ImFriendShipGroupServiceImpl implements ImFriendShipGroupService {
    ...
    public ResponseVO addGroup(AddFriendShipGroupReq req) {
        ...
        if (entity != null) return ResponseVO.errorResponse(FriendShipErrorCode.FRIEND_SHIP_GROUP_IS_EXIST);
        ...
        try {
            ...
            if (insert1 != 1) return ResponseVO.errorResponse(FriendShipErrorCode.FRIEND_SHIP_GROUP_CREATE_ERROR);
    ...
    public ResponseVO getGroup(String fromId, String groupName, Integer appId) {
        ...
        ImFriendShipGroupEntity entity = imFriendShipGroupMapper.selectOne(query);
        if (entity == null) return ResponseVO.errorResponse(FriendShipErrorCode.FRIEND_SHIP_GROUP_IS_NOT_EXIST);
